#!/usr/bin/python3
"""a file for the command line interpreter"""
import cmd
import shlex
...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """don't execute last command with empty line"""
        pass
    ...
    def do_destroy(self, line):
        """delete object based on class and id"""
        args = line.split(" ")
        if args[0] in self.class_name:
            try:
                args[1]
    ...
    def do_all(self, line):
        """print all object or all class instances"""
        if line in self.class_name:
            all_obj = storage.all()
            all_int = []
    ...
    def do_update(self, line):
        """add or update attribute of an object"""
